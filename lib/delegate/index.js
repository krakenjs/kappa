...
exports.createHandler = function (registries) {
    ...
    return function (req, reply) {
        ...
        // fix to allow scoped packages
        var url = Url.format(req.url).replace(/(\/[^@]*)(@[^\/]+)(\/)(.+)/, '$1$2%2F$4');
        // correct scoped package request to make it work
        ...
        async.doWhilst(
            ...
            function complete(err) {
                if (!req._isReplied) {
                  ...
                  // NOW: Multiple calls to reply, procudes an error
